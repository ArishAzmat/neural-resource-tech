                ...
                <nav className="navbar navbar-expand-lg stroke px-0">
                    ...
                    <h1>
                        <a className="navbar-brand" href="index.html">
                            {/* <!-- <i className="fab fa-accusoft icon-color mr-1"></i> N<span className="icon-color" style="font-weight:700;">R</span><span style="font-weight:500;">T</span>
                        <br>
                        <span className="inner-text">Neural Resource Technologies</span> --> */}
